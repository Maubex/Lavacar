...
DATABASES = {
    'default': {
        ...
        'NAME': 'americabd',  # Nome do banco de dados criado no PostgreSQL
        'USER': 'postgres',    # Usuário do banco de dados
        'PASSWORD': '92u8v2zj',  # Senha do banco de dados
...
# Configuração do formato de localização para números e datas
LOCALE_PATHS = [
